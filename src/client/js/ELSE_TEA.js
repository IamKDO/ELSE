/* ============================================================================
	ELSE_TEA.js is part of ELSE, the Extended Library for Surveys Engine
...
_ELSE_._XXTEA = (function() {
	...
	// Base 64 encoding / decoding (c) Chris Veness 2002-2012
	// =========================================================================
	/**
	 ...
	 */ 
	function BASE64_encode(str, utf8encode) {  // http://tools.ietf.org/html/rfc4648
		utf8encode =  (typeof utf8encode == 'undefined') ? false : utf8encode;
		var o1, o2, o3, bits, h1, h2, h3, h4, e=[], pad = '', c, plain, coded;
		var b64 = BASE64_CODE;
   
		plain = utf8encode ? UTF8_encode(str) : str;
	 ...
	 */ 
	function BASE64_decode(str, utf8decode) {
		utf8decode =  (typeof utf8decode == 'undefined') ? false : utf8decode;
		var o1, o2, o3, h1, h2, h3, h4, bits, d=[], plain, coded;
		var b64 = BASE64_CODE;

		coded = utf8decode ? UTF8_decode(str) : str;
		...
		return utf8decode ? UTF8_decode(plain) : plain; 
	};

	//  Utf8 encode / decode between multi-byte Unicode characters and UTF-8 multiple
	...
	return {
		...
		encrypt : function(plaintext, password) {
			...
			var v = strToLongs(UTF8_encode(plaintext));
			if (v.length <= 1) v[1] = 0;  // algorithm doesn't work for n<2 so fudge by adding a null
			// simply convert first 16 chars of password as key
			var k = strToLongs(UTF8_encode(password).slice(0,16));  
			var n = v.length;
		...
		decrypt : function(ciphertext, password) {
			...
			var v = strToLongs(BASE64_decode(ciphertext));
			var k = strToLongs(UTF8_encode(password).slice(0,16)); 
			var n = v.length;
